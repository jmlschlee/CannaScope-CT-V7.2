...
CannaScope_CT_V16.py. Embeds the engine modules + OCR worker, PLUS a compressed
...
TWO REPORTS
  Statewide Transparency Report (whole market):
    ...
    python3 CannaScope_CT_V16.py statewide --since 2024-01-01 --until 2024-12-31
  ...
  Personalized Product Concern Report (one product, for a consumer concern):
    python3 CannaScope_CT_V16.py concern --batch <BATCH> --ndc <NDC> --qr <URL>
    python3 CannaScope_CT_V16.py concern --example
